...
//
// Creates a Flutterwave v3 STATIC virtual account (Zenith Bank) for the
...
const ISSUING_BANK_CODE = "057"; // Zenith Bank — Sterling (232) isn't in Flutterwave's supported bank list for this product; WoodPayVTU already uses Wema (035), so Zenith keeps that separation
